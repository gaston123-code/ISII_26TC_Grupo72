...
<head>
    ...
    <title>AutoRent - @yield('title', 'Bienvenido')</title>
        ...
        <div class="dashboard-layout">
            ...
            <aside class="sidebar" id="sidebar" aria-label="Navegación lateral">
                ...
                <nav class="sidebar-nav">
                    ...
                    <a href="{{ route('catalogo') }}" class="nav-item">
                        <i class="fa-solid fa-car-side"></i> <span class="nav-text">{{ __('Ver Flota') }}</span>
                    </a>
                    <a href="{{ route('cliente.reserva.index') }}" class="nav-item">
                        <i class="fa-solid fa-calendar-check"></i> <span class="nav-text">{{ __('Mis Reservas') }}</span>
                    </a>

                    <!-- Bloque exclusivo para Administradores -->
                    {{-- NOTA: Cambia 'rol' o 'admin' por los valores exactos que utilices posteriormente en tu Base de Datos --}}
                    @if(Auth::check() && isset(Auth::user()->rol) && Auth::user()->rol === 'admin')
                        ...
                        <a href="/dashboard" class="nav-item active">
                            <i class="fa-solid fa-house"></i> <span class="nav-text">{{ __('Panel Principal') }}</span>
                        </a>
                        <a href="#" class="nav-item">
                            <i class="fa-solid fa-users"></i> <span class="nav-text">{{ __('Gestión de Clientes') }}</span>
                        </a>
                        <a href="#" class="nav-item">
                            <i class="fa-solid fa-chart-line"></i> <span class="nav-text">{{ __('Reportes') }}</span>
                        </a>
                    @endif
                </nav>
            </aside>
            ...
            <main class="main-content">
                ...
                <footer class="footer-minimal text-center">
                    <small>&copy; {{ date('Y') }} AutoRent. {{ __('Operando de forma segura.') }}</small>
                </footer>
            </main>
        </div>
