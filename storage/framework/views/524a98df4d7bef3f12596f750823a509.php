                ...
                <header class="top-header">
                    ...
                    <div class="user-menu">
                        <?php if(Auth::guard('cliente')->check()): ?>
                            <div class="user-info">
                                <span class="user-name"><?php echo e(Auth::guard('cliente')->user()->nombre); ?></span>
                                <div class="avatar">
                                    <?php echo e(substr(Auth::guard('cliente')->user()->nombre, 0, 1)); ?>
                        ...
                        <?php elseif(Auth::guard('admin')->check()): ?>
                            ...
                            <a href="<?php echo e(route('admin.dashboard')); ?>" class="btn btn-primary btn-sm" style="margin-right: 10px;">Ir al Panel</a>
                            <form method="POST" action="<?php echo e(route('logout')); ?>" class="logout-form">
                                <?php echo csrf_field(); ?>
                                <button type="submit" class="btn-link" title="Cerrar Sesión">
                                    <i class="fa-solid fa-right-from-bracket"></i>
                        ...
                        <?php else: ?>
                            <div class="auth-buttons">
                                ...
                                <a href="<?php echo e(route('register')); ?>" class="btn btn-outline btn-sm">Registro</a>
                            </div>
                        <?php endif; ?>
                    </div>
                </header>
...
<?php /**PATH C:\xampp\htdocs\ISII_26TC_Grupo72\resources\views/layouts/app.blade.php ENDPATH**/ ?>