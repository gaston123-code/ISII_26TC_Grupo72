...
unset($__errorArgs, $__bag); ?>" value="<?php echo e(old('fecha_retiro', date('Y-m-d'))); ?>" required>
                    <?php $__errorArgs = ['fecha_retiro'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
                        <span class="error-message" style="font-size: 12px; color: #dc2626; margin-top: 4px; display: block;"><?php echo e($message); ?></span>
                    <?php unset($message);
if (isset($__messageOriginal)) { $message = $__messageOriginal; }
endif;
...
unset($__errorArgs, $__bag); ?>" value="<?php echo e(old('hora_retiro', '09:00')); ?>" required>
                    <?php $__errorArgs = ['hora_retiro'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
unset($__errorArgs, $__bag); ?>" value="<?php echo e(old('fecha_devolucion', date('Y-m-d', strtotime('+1 day')))); ?>" required>
...
unset($__errorArgs, $__bag); ?>" value="<?php echo e(old('hora_devolucion', '18:00')); ?>" required>
                    <?php $__errorArgs = ['hora_devolucion'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\ISII_26TC_Grupo72\resources\views/reservar.blade.php ENDPATH**/ ?>