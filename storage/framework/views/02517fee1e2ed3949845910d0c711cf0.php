...
<div class="card">
    ...
    <form method="POST" action="<?php echo e(route('login.submit')); ?>">
        ...
        <div class="form-group" style="display: flex; align-items: center; justify-content: space-between;">
            <label style="display: inline-flex; align-items: center; font-weight: 400;">
                <input type="checkbox" name="remember" id="remember" <?php echo e(old('remember') ? 'checked' : ''); ?> style="width: auto; margin-right: 8px;">
                Recordarme
            </label>
        </div>
    ...
    <div class="footer-links">
        ¿No tenés cuenta? <a href="<?php echo e(route('register')); ?>">Registrate gratis</a>
        <br><br>
        <a href="<?php echo e(route('catalogo')); ?>">← Volver al catálogo</a>
    </div>
</div>
</body>
</html>
<?php /**PATH C:\xampp\htdocs\ISII_26TC_Grupo72\resources\views/auth/login.blade.php ENDPATH**/ ?>