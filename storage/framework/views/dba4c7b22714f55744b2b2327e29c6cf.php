            ...
            <?php $__currentLoopData = $reservas; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $reserva): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <div class="reservation-card" style="padding: 1.5rem; display: flex; flex-wrap: wrap; gap: 2rem; align-items: center; justify-content: space-between; border-left: 5px solid #2563eb;">
                    ...
                    <div style="min-width: 120px;">
                        ...
                        ?>
                        <span style="<?php echo e($statusLabelStyle); ?>">
                    ...
                    <div style="min-width: 50px; display: flex; gap: 0.5rem;">
                        ...
                        <?php if($reserva->id_estadoAlquiler != 5): ?>
                            <form action="<?php echo e(route('cliente.reserva.cancel', $reserva->id_reserva)); ?>" method="POST" onsubmit="return confirm('¿Estás seguro de que deseas cancelar esta reserva? El auto volverá a estar disponible para otros clientes.')" style="display:inline;">
                                <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\ISII_26TC_Grupo72\resources\views/mis-reservas.blade.php ENDPATH**/ ?>