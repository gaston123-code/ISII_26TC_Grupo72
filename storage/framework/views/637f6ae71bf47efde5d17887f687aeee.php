...
<div class="card">
    ...
    <form method="POST" action="<?php echo e(route('cliente.login.submit')); ?>">
        <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>
    ...
    <div class="footer-links">
        ¿No tenés cuenta? <a href="<?php echo e(route('cliente.register')); ?>">Registrate gratis</a>
        <br><br>
...
<?php /**PATH C:\xampp1\htdocs\ISII_26TC_Grupo72-main\resources\views/auth/cliente-login.blade.php ENDPATH**/ ?>