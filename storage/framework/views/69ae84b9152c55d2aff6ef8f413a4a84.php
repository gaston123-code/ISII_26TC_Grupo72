...
<head>
    ...
    <title><?php echo $__env->yieldContent('title', 'AutoRent'); ?> — Panel de Administración</title>
...
<aside class="sidebar">
    ...
    <nav>
        ...
        <a href="<?php echo e(route('admin.autos.index')); ?>" class="<?php echo e(request()->routeIs('admin.autos.*') ? 'active' : ''); ?>">
            🚘 Gestión de Autos
        </a>
    ...
    <div class="sidebar-footer">
        <p style="font-size:12px; color:#64748b; margin-bottom:8px;">
            <?php echo e(auth('admin')->user()->nombre ?? 'Admin'); ?>
...
<div class="main-wrapper">
    <div class="topbar">
        <h1><?php echo $__env->yieldContent('page-title', 'Panel'); ?></h1>
...
<?php /**PATH C:\xampp\htdocs\ISII_26TC_Grupo72\resources\views/layouts/admin.blade.php ENDPATH**/ ?>