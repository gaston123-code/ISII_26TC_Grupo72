...
<div class="reservation-wrapper mt-5 mb-5" style="max-width: 650px; margin: 0 auto;">
    <div class="reservation-card text-center" style="padding: 4rem 2rem; box-shadow: 0 20px 50px rgba(0,0,0,0.1); border: none;">
        ...
        <h1 style="font-size: 2.5rem; font-weight: 800; color: #064e3b; margin-bottom: 1rem;">¡Reserva Confirmada!</h1>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\car_a\OneDrive\Desktop\bd\ISII_26TC_Grupo72-main\resources\views/reserva-exitosa.blade.php ENDPATH**/ ?>